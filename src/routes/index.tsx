...
import { AboutSection, ResearchInterestsSection } from "@/components/site/about";
import { ContactCv } from "@/components/site/contact-cv";
import { EducationSection, ExperienceSection } from "@/components/site/experience";
import { Hero } from "@/components/site/hero";
import { AwardsSection, SkillsSection } from "@/components/site/records";
import { PublicationsSection, ResearchProjectsSection } from "@/components/site/research";
...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Md. Mehedi Hasan — AI & Machine Learning Researcher" },
      {
