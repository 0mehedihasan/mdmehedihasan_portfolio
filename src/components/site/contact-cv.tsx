        ...
        <div className="card-surface flex flex-col items-start justify-between gap-6 p-8 sm:flex-row sm:items-center">
          <div>
            ...
            <p className="mt-2 max-w-xl text-sm text-muted-foreground">
              The complete record of education, research experience,
              publications, activities, and awards. Open to research
              assistantships, data roles, and MSc/PhD opportunities.
            </p>
          </div>
